...
public class InviteCommandHandler {
    ...
    public boolean handleCommand(Player player, String[] args) {
        if (args.length > 1) {
            ...
            // Проверка, состоит ли игрок уже в другом клане
            if (playerClan != null) {
            ...
            if (invites.contains(clan.getName().toLowerCase())) {
                ...
                invites.remove(clan.getName().toLowerCase());
                ...
                try {
                    ...
                    invites.add(clan.getName().toLowerCase());
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            if (currentInvites != null && currentInvites.contains(clan.getName().toLowerCase())) {
                                currentInvites.remove(clan.getName().toLowerCase());
            ...
            // Выводим сообщение с инструкцией, если недостаточно аргументов

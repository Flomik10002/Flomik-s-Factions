...
//        info.append(ChatColor.GOLD).append("Уровень: ").append(ChatColor.YELLOW).append(clan.getLevel()).append(" (").append(clan.getClanXp()).append("/").append(clan.getRequiredXpForNextLevel(clan.getClanXp())).append(") до след. lvl").append("\n");

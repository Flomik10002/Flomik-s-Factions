...
public class ClaimRegionHandler {
    ...
    public ClaimRegionHandler(ClanManager clanManager, UnclaimRegionHandler unclaimRegionHandler, ShrineEvent shrineEvent) {
        this.clanManager = clanManager;
        this.unclaimRegionHandler = unclaimRegionHandler;
            ...
            for (Clan oldClan : clanManager.clans.values()) {
                if (!oldClan.equals(clan) && oldClan.hasClaimedChunk(chunkId)) {
                    if (oldClan.getLands() > oldClan.getStrength())
                    {
                        ...
                        unclaimRegionHandler.removeWorldGuardRegion(chunk, oldClan.getName());
